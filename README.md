...
There are thousands of AI tools out there, and most of them are noise. This list is the antidote: a hand-picked set of resources organized by what you're actually trying to do — ship a product, run ads, raise money, design a brand, or just get more done in less time.
...
Built and maintained by founders. We work on AI products full-time and keep this list current because we use it ourselves. If a tool stops being useful, it gets removed. If something new earns its place, it gets added.

## Contributing

PRs and suggestions are very welcome. The bar is high — we only accept tools we'd recommend to a friend. Read [CONTRIBUTING.md](CONTRIBUTING.md) before submitting.
